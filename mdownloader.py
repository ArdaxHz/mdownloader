...
if __name__ == "__main__":
    ...
    parser.add_argument('--check_images', '-c', default='names', nargs='?', const='skip', choices=['names', 'skip'], help='Check if the chapter folder and/or zip has the same files as the chapter on MangaDex. Read the Readme for more information.') #data or names or skip

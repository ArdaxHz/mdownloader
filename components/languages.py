...
def get_lang_iso(language: str) -> str:
    ...
    Args:
        language (str): ISO 639-1 code used by md.
...
def get_lang_md(language: str) -> str:
    ...
    Args:
        language (str): Can be the full language name, ISO 639-1 or ISO 639-3 codes.

    Raises:
        MDownloaderError: Couldn't find the language selected.

    Returns:
        str: ISO 639-1 code, which MangaDex uses for languages.
    """
